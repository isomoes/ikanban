window.__ModuleLoader__.load({
	id: "@isomoes/dsh-ikanban-ui-workspace",
	factory: (require) => {
		var module = { exports: {} };
		...
		*/
		...
		const tagId$2 = "@isomoes/dsh-ikanban-ui-workspace/Rows.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$2) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@isomoes/dsh-ikanban-ui-workspace";
		...
		*/
		...
		const tagId = "@isomoes/dsh-ikanban-ui-workspace/WorkspaceBrowser.module.css";
