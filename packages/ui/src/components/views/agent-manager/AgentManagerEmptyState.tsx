...
import type { ProjectRef } from '@/lib/ikanbanConfig';
...
export const AgentManagerEmptyState: React.FC<AgentManagerEmptyStateProps> = ({ 
  ...
  const isVSCodeRuntime = React.useMemo(() => {
    ...
    const apis = (window as unknown as { __IKANBAN_RUNTIME_APIS__?: { runtime?: { isVSCode?: boolean } } }).__IKANBAN_RUNTIME_APIS__;
