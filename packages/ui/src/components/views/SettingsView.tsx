...
import { IKanbanPage } from '@/components/sections/ikanban/IKanbanPage';
import { IKanbanSidebar, type IKanbanSection } from '@/components/sections/ikanban/IKanbanSidebar';
...
export const SettingsView: React.FC<SettingsViewProps> = ({ onClose, forceMobile, isWindowed }) => {
  ...
  const [selectedIKanbanSection, setSelectedIKanbanSection] = React.useState<IKanbanSection>('visual');
      ...
      case 'settings':
        return (
          <div className="h-full">
            <IKanbanSidebar
              selectedSection={selectedIKanbanSection}
              onSelectSection={(section) => {
                setSelectedIKanbanSection(section);
  ...
  const renderPageContent = () => {
    switch (activeTab) {
      ...
      case 'settings':
        return <IKanbanPage section={selectedIKanbanSection} />;
      default:
        return null;
    }
  };
