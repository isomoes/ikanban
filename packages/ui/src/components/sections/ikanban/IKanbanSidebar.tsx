...
export type IKanbanSection = 'visual' | 'chat' | 'sessions' | 'git' | 'github' | 'notifications' | 'voice';

interface IKanbanSidebarProps {
  selectedSection: IKanbanSection;
  onSelectSection: (section: IKanbanSection) => void;
}
...
const IKANBAN_SECTION_GROUPS: SectionGroup[] = [
  {
    id: 'visual',
    label: 'Visual',
...
export const IKanbanSidebar: React.FC<IKanbanSidebarProps> = ({
  selectedSection,
  onSelectSection,
}) => {
  ...
  const visibleSections = React.useMemo(() => {
    return IKANBAN_SECTION_GROUPS.filter((group) => {
