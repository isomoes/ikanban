...
import { IKanbanVisualSettings } from './IKanbanVisualSettings';
...
import type { IKanbanSection } from './IKanbanSidebar';
...
export const IKanbanPage: React.FC<IKanbanPageProps> = ({ section }) => {
    ...
    if (!section) {
        return (
            <ScrollableOverlay
                ...
                className="w-full"
            >
                <div className="ikanban-page-body mx-auto max-w-3xl space-y-3 p-3 sm:space-y-6 sm:p-6">
                    <IKanbanVisualSettings />
    ...
    return (
        <ScrollableOverlay
            ...
            className="w-full"
        >
            <div className="ikanban-page-body mx-auto max-w-3xl space-y-6 p-3 sm:p-6">
...
const VisualSectionContent: React.FC = () => {
    return <IKanbanVisualSettings visibleSettings={['theme', 'fontSize', 'terminalFontSize', 'spacing', 'cornerRadius', 'inputBarOffset', 'terminalQuickKeys']} />;
};

// Chat section: Default Tool Output, Diff layout, Show reasoning traces, Queue mode, Persist draft
const ChatSectionContent: React.FC = () => {
    return <IKanbanVisualSettings visibleSettings={['toolOutput', 'diffLayout', 'dotfiles', 'reasoning', 'textJustificationActivity', 'queueMode', 'persistDraft']} />;
};
