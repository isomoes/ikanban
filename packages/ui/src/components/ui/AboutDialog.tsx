...
import { IKanbanLogo } from '@/components/ui/IKanbanLogo';
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-xs p-6">
        <div className="flex flex-col items-center text-center space-y-4">
          <IKanbanLogo width={64} height={64} />

          <div className="space-y-1">
            <h2 className="text-lg font-semibold">IKanban</h2>
            {displayVersion && (
          ...
          <div className="flex flex-col items-center gap-2 pt-2">
            ...
            <p className="typography-micro text-muted-foreground">
              Includes IKanban state, OpenCode health, directories, and projects.
            </p>
          </div>

          <div className="flex items-center gap-4 pt-2">
            <a
              href="https://github.com/btriapitsyn/ikanban"
              target="_blank"
              rel="noopener noreferrer"
