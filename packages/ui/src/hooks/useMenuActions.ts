...
const MENU_ACTION_EVENT = 'ikanban:menu-action';
const CHECK_FOR_UPDATES_EVENT = 'ikanban:check-for-updates';
...
export const useMenuActions = (
  ...
  React.useEffect(() => {
    ...
    listen('ikanban:menu-action', (evt) => {
    ...
    listen('ikanban:check-for-updates', () => {
