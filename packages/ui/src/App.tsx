...
function App({ apis }: AppProps) {
  ...
  React.useEffect(() => {
    ...
    (window as unknown as { __ikanbanAppReady?: boolean }).__ikanbanAppReady = true;
    window.dispatchEvent(new Event('ikanban:app-ready'));
  ...
  if (isVSCodeRuntime) {
    ...
    const panelType = typeof window !== 'undefined' 
      ? (window as { __IKANBAN_PANEL_TYPE__?: 'chat' | 'agentManager' }).__IKANBAN_PANEL_TYPE__ 
      : 'chat';
