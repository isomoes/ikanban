  ...
  init: () => {
    ...
    const model = (() => {
      ...
      const resolveConfigured = () => {
        ...
        const providerID = typeof model === "string" ? model.slice(0, model.indexOf("/")) : model.providerID
        const modelID = typeof model === "string" ? model.slice(model.indexOf("/") + 1).split("#")[0] : model.model
