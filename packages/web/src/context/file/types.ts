import type { FileContent, SnapshotFileDiff } from "@/client/types"
import { parsePatch, type StructuredPatch } from "diff"

/**
 * Canonical diff shape used throughout the app UI.
 *
 * V2 returns patch-only diffs. The restored UI models explicit before/after
 * content keyed by file, so convert native payloads at this boundary.
 */
