...
export async function bootstrapDirectory(input: {
  ...
  return Promise.all([
    ...
    input.setStore("status", "partial")
    showToast({ variant: "error", title: getFilename(input.directory), description: formatServerError(error, { unknown: input.unknownError, invalidConfiguration: input.invalidConfigurationError }) })
  })
}
