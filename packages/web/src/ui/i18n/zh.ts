...
export const dict = {
  ...
  "ui.sessionReview.title.project": "项目变更",
  "ui.sessionReview.title.lastTurn": "上一轮变更",
  "ui.sessionReview.diffStyle.label": "差异样式",
  ...
  "ui.sessionReview.summary.file": "{{count}} 个文件变更",
  "ui.sessionReview.summary.files": "{{count}} 个文件变更",
  "ui.sessionReview.viewed": "已查看",
  "ui.sessionReview.viewedProgress": "已查看 {{viewed}}/{{total}}",
  "ui.sessionReview.filter.placeholder": "筛选变更文件",
  "ui.sessionReview.filter.noMatches": "没有匹配“{{query}}”的文件",
