export const dict = {
  ...
  "prompt.context.region": "Prompt context and attachments",
  ...
  "prompt.action.collapse": "Collapse editor",
  ...
  "dialog.server.add.username": "Basic username (leave empty for Bearer token)",
  "dialog.server.add.password": "Password / Bearer token",
  ...
  "session.messages.totalRunTime": "Total run time",
