...
export const dict = {
  ...
  "prompt.context.region": "提示词上下文和附件",
  ...
  "dialog.server.add.username": "Basic 用户名（Bearer Token 留空）",
  "dialog.server.add.password": "密码 / Bearer Token",
  ...
  "session.messages.totalRunTime": "总运行时长",
  ...
  "settings.general.section.releaseNotes": "发行说明",
