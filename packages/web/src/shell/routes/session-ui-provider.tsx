import { DataProvider } from "@ikanban/session-ui/context"
import { MarkdownProvider, type ReadMarkdownImage } from "@ikanban/session-ui/context/markdown"
...
export function SessionUIProvider(
  ...
  const href = (sessionID: string) => appHref(sessionHref(props.server, sessionID))
  const navigateToSession = async (sessionID: string) => {
    ...
    navigate(sessionHref(props.server, sessionID))
  }
