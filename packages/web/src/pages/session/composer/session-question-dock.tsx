...
import { SessionFormDock } from "./session-form-dock"

export const SessionQuestionDock: Component<{ request: QuestionRequest; onSubmit: () => void }> = (props) => {
  return <Show when={props.request.form} fallback={<QuestionDock {...props} />}>{(form) => <SessionFormDock form={form()} onSubmit={props.onSubmit} />}</Show>
}

const QuestionDock: Component<{ request: QuestionRequest; onSubmit: () => void }> = (props) => {
  const sdk = useSDK()
