    ...
    >
      ...
      <DropdownMenu.Portal mount={!props.mobile ? props.nav() : undefined}>
        ...
        >
          ...
          <DropdownMenu.Item
            disabled
            title="OpenCode V2 does not expose worktree reset"
          >
...
export const SortableWorkspace = (props: {
  ...
  const hasMore = createMemo(() => workspaceStore.sessionTotal > workspaceStore.session.filter((session) => !session.parentID).length)
