...
export const dict = {
  ...
  "settings.about.ikanbanDescription": "A standalone frontend for OpenCode V2.",
  "settings.about.ikanbanRepository": "Source code",
  "settings.about.ikanbanIssues": "Report an issue",
  "settings.about.ikanbanReleases": "Releases",
  "settings.about.ikanbanContributors": "Contributors",
  "settings.about.ikanbanUpstream": "Built on the shared desktop/web frontend from",
