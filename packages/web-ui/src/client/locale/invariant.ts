/**
 * Package-owned invariant companion for `@isomoes/dsh-web-ui/client/locale`.
 * @module @isomoes/dsh-web-ui/client/locale/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-web-ui/client/locale'
