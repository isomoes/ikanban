/**
 * Package-owned invariant companion for `@isomoes/dsh-ikanban/client/locale`.
 * @module @isomoes/dsh-ikanban/client/locale/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-ikanban/client/locale'
