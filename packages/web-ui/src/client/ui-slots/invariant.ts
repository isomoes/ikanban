/**
 * Package-owned invariant companion for `@isomoes/dsh-ikanban/client/ui-slots`.
 * @module @isomoes/dsh-ikanban/client/ui-slots/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-ikanban/client/ui-slots'
