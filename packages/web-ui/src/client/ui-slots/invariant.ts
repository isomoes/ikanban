/**
 * Package-owned invariant companion for `@isomoes/dsh-web-ui/client/ui-slots`.
 * @module @isomoes/dsh-web-ui/client/ui-slots/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-web-ui/client/ui-slots'
