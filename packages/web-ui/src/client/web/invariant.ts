/**
 * Package-owned invariant companion for `@isomoes/dsh-ikanban/client/web`.
 * @module @isomoes/dsh-ikanban/client/web/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-ikanban/client/web'
