/**
 * Package-owned invariant companion for `@isomoes/dsh-web-ui/client/web`.
 * @module @isomoes/dsh-web-ui/client/web/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-web-ui/client/web'
