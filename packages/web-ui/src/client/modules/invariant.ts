/**
 * Package-owned invariant companion for `@isomoes/dsh-ikanban/client/modules`.
 * @module @isomoes/dsh-ikanban/client/modules/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-ikanban/client/modules'
