/**
 * Package-owned invariant companion for `@isomoes/dsh-web-ui/client/modules`.
 * @module @isomoes/dsh-web-ui/client/modules/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-web-ui/client/modules'
