 ...
 * @module @isomoes/dsh-web-ui/client/modules
 */
...
function exactPackageSpecifier(specifier: string): string | undefined {
  if (
    specifier.startsWith('@isomoes/dsh-web-ui/client/')
    || specifier.startsWith('@isomoes/dsh-ikanban/client/')
  ) return specifier
...
const CLIENT_MODULES_ID = '@isomoes/dsh-web-ui/client/modules'
