...
import type { ConnectionIndicatorState } from '@isomoes/dsh-web-ui/client/ui-primitives'
...
export function SettingsRoot(props: SettingsRootComponentProps) {
  const {
    wide, reconnect, registerOpenAction, useConnectionState, useSections, useOnboardingSteps, useSessions, renderSlot, t,
  } = props
  ...
  useEffect(() => registerOpenAction(() => { setOpen(true) }), [registerOpenAction])
