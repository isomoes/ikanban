/**
 * Package-owned invariant companion for `@isomoes/dsh-web-ui/client/ui-settings`.
 * @module @isomoes/dsh-web-ui/client/ui-settings/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-web-ui/client/ui-settings'
