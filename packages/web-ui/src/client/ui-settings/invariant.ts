/**
 * Package-owned invariant companion for `@isomoes/dsh-ikanban/client/ui-settings`.
 * @module @isomoes/dsh-ikanban/client/ui-settings/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-ikanban/client/ui-settings'
