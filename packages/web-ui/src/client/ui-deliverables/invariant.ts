/**
 * Package-owned invariant companion for `@isomoes/dsh-ikanban/client/ui-deliverables`.
 * @module @isomoes/dsh-ikanban/client/ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-ikanban/client/ui-deliverables'
