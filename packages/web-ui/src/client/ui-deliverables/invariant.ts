/**
 * Package-owned invariant companion for `@isomoes/dsh-web-ui/client/ui-deliverables`.
 * @module @isomoes/dsh-web-ui/client/ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-web-ui/client/ui-deliverables'
