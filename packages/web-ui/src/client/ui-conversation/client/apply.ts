...
export const inject = [
  'slots', 'sessions', 'uiSession', 'uiWorkspace', 'locale', 'settingsScope', 'commandUi',
]
...
export function apply(ctx: Context): void {
  ...
  const sessionViewActions = new Map<SessionId, BoundActions<typeof conversationStore>>()
  const currentViewActions = (): BoundActions<typeof conversationStore> | undefined => {
