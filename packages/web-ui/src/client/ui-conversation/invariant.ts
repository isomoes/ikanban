/**
 * Package-owned invariant companion for `@isomoes/dsh-ikanban/client/ui-conversation`.
 * @module @isomoes/dsh-ikanban/client/ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-ikanban/client/ui-conversation'
