/**
 * Package-owned invariant companion for `@isomoes/dsh-web-ui/client/ui-conversation`.
 * @module @isomoes/dsh-web-ui/client/ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-web-ui/client/ui-conversation'
