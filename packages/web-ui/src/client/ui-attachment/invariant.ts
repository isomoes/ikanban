/**
 * Package-owned invariant companion for `@isomoes/dsh-ikanban/client/ui-attachment`.
 * @module @isomoes/dsh-ikanban/client/ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-ikanban/client/ui-attachment'
