/**
 * Package-owned invariant companion for `@isomoes/dsh-web-ui/client/ui-attachment`.
 * @module @isomoes/dsh-web-ui/client/ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-web-ui/client/ui-attachment'
