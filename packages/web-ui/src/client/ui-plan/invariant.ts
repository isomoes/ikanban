/**
 * Package-owned invariant companion for `@isomoes/dsh-ikanban/client/ui-plan`.
 * @module @isomoes/dsh-ikanban/client/ui-plan/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-ikanban/client/ui-plan'
