/**
 * Package-owned invariant companion for `@isomoes/dsh-web-ui/client/ui-plan`.
 * @module @isomoes/dsh-web-ui/client/ui-plan/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-web-ui/client/ui-plan'
