/**
 * Package-owned invariant companion for `@isomoes/dsh-ikanban/client/ui-workspace`.
 * @module @isomoes/dsh-ikanban/client/ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-ikanban/client/ui-workspace'
