/**
 * Package-owned invariant companion for `@isomoes/dsh-web-ui/client/ui-workspace`.
 * @module @isomoes/dsh-web-ui/client/ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-web-ui/client/ui-workspace'
