...
export const zh = {
  ...
  'changes.loading': '正在读取工作区变更…',
  'changes.empty': '工作区没有变更',
  'changes.notRepository': '此工作区不是 Git 仓库',
  'changes.truncated': '差异过大，仅显示部分内容。',
  'changes.fileTruncated': '此文件变更过大，仅显示前面部分。',
  'changes.noTextDiff': '无文本差异',
  'changes.status.added': '新增',
  'changes.status.modified': '修改',
  'changes.status.deleted': '删除',
  'changes.status.renamed': '重命名',
  'changes.status.conflicted': '冲突',
...
export const en = {
  ...
  'menu.unarchiveSession': 'Undo session',
  ...
  'changes.loading': 'Reading workspace changes…',
  'changes.empty': 'No workspace changes',
  'changes.notRepository': 'This workspace is not a Git repository',
  'changes.truncated': 'The diff is large, so only part of it is shown.',
  'changes.fileTruncated': 'This file changed heavily, so only the beginning is shown.',
  'changes.noTextDiff': 'No textual diff',
  'changes.status.added': 'Added',
  'changes.status.modified': 'Modified',
  'changes.status.deleted': 'Deleted',
  'changes.status.renamed': 'Renamed',
  'changes.status.conflicted': 'Conflict',
