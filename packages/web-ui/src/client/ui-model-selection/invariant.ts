/**
 * Package-owned invariant companion for `@isomoes/dsh-web-ui/client/ui-model-selection`.
 * @module @isomoes/dsh-web-ui/client/ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-web-ui/client/ui-model-selection'
