/**
 * Package-owned invariant companion for `@isomoes/dsh-ikanban/client/ui-model-selection`.
 * @module @isomoes/dsh-ikanban/client/ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-ikanban/client/ui-model-selection'
