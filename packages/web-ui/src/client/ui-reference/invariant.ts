/**
 * Package-owned invariant companion for `@isomoes/dsh-web-ui/client/ui-reference`.
 * @module @isomoes/dsh-web-ui/client/ui-reference/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-web-ui/client/ui-reference'
