/**
 * Package-owned invariant companion for `@isomoes/dsh-web-ui/client/ui-goal`.
 * @module @isomoes/dsh-web-ui/client/ui-goal/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-web-ui/client/ui-goal'
