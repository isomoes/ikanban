/**
 * Package-owned invariant companion for `@isomoes/dsh-ikanban/client/ui-goal`.
 * @module @isomoes/dsh-ikanban/client/ui-goal/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-ikanban/client/ui-goal'
