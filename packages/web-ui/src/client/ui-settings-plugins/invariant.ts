/**
 * Package-owned invariant companion for `@isomoes/dsh-ikanban/client/ui-settings-plugins`.
 * @module @isomoes/dsh-ikanban/client/ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-ikanban/client/ui-settings-plugins'
