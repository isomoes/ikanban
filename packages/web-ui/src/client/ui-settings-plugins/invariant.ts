/**
 * Package-owned invariant companion for `@isomoes/dsh-web-ui/client/ui-settings-plugins`.
 * @module @isomoes/dsh-web-ui/client/ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-web-ui/client/ui-settings-plugins'
