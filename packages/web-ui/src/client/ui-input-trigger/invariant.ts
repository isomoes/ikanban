/**
 * Package-owned invariant companion for `@isomoes/dsh-web-ui/client/ui-input-trigger`.
 * @module @isomoes/dsh-web-ui/client/ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-web-ui/client/ui-input-trigger'
