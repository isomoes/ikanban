/**
 * Package-owned invariant companion for `@isomoes/dsh-ikanban/client/ui-input-trigger`.
 * @module @isomoes/dsh-ikanban/client/ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-ikanban/client/ui-input-trigger'
