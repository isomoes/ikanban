/**
 * Package-owned invariant companion for `@isomoes/dsh-ikanban/client/ui-subagent`.
 * @module @isomoes/dsh-ikanban/client/ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-ikanban/client/ui-subagent'
