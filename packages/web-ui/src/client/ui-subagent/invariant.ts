/**
 * Package-owned invariant companion for `@isomoes/dsh-web-ui/client/ui-subagent`.
 * @module @isomoes/dsh-web-ui/client/ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-web-ui/client/ui-subagent'
