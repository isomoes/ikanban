...
import { Button, IconChevronDownOutline14, Modal } from '@isomoes/dsh-web-ui/client/ui-primitives'
...
import {
  historyScrollDelta, isHistoryNavigationKey,
} from '../../../ui-conversation/client/chat/history-keyboard.ts'
...
export function ChatView({
  ...
  useEffect(() => {
    const onDocumentKeyDown = (event: globalThis.KeyboardEvent): void => {
      if (
        event.defaultPrevented || !isHistoryNavigationKey(event.key)
