/**
 * Package-owned invariant companion for `@isomoes/dsh-web-ui/client/ui-user-questions`.
 * @module @isomoes/dsh-web-ui/client/ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-web-ui/client/ui-user-questions'
