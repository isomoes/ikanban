/**
 * Package-owned invariant companion for `@isomoes/dsh-ikanban/client/ui-user-questions`.
 * @module @isomoes/dsh-ikanban/client/ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-ikanban/client/ui-user-questions'
