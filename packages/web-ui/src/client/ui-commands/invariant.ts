/**
 * Package-owned invariant companion for `@isomoes/dsh-web-ui/client/ui-commands`.
 * @module @isomoes/dsh-web-ui/client/ui-commands/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-web-ui/client/ui-commands'
