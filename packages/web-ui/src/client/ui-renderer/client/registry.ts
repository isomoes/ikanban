...
import { SlotCore, standardHookPropName } from '@isomoes/dsh-web-ui/client/ui-slots'
import type {
...
export class SlotRegistry extends Service {
  ...
  private rebuildRootBinding(): void {
    ...
    const keyedHooks: Record<string, import('@isomoes/dsh-web-ui/client/ui-slots').KeyedStandardSource> = {}
