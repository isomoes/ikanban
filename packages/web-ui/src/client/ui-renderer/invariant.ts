/**
 * Package-owned invariant companion for `@isomoes/dsh-ikanban/client/ui-renderer`.
 * @module @isomoes/dsh-ikanban/client/ui-renderer/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-ikanban/client/ui-renderer'
