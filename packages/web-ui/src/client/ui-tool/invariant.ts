/**
 * Package-owned invariant companion for `@isomoes/dsh-ikanban/client/ui-tool`.
 * @module @isomoes/dsh-ikanban/client/ui-tool/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-ikanban/client/ui-tool'
