/**
 * Package-owned invariant companion for `@isomoes/dsh-web-ui/client/ui-tool`.
 * @module @isomoes/dsh-web-ui/client/ui-tool/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-web-ui/client/ui-tool'
