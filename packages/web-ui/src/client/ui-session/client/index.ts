...
import { standardHookPropName } from '@isomoes/dsh-web-ui/client/ui-slots'
import type {
  HostObservable,
  KeyedStandardSource,
...
export class UiSession extends Service {
  ...
  readonly pendingInteractions: HostObservable<SessionPendingInteractionSnapshot> = {
    // The runtime map stores the common base while flattened domain declarations
    // refine the public union through module augmentation.
