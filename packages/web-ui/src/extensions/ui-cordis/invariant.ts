/**
 * Package-owned invariant companion for `@isomoes/dsh-ikanban/client/ui-cordis`.
 * @module @isomoes/dsh-ikanban/client/ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-ikanban/client/ui-cordis'
