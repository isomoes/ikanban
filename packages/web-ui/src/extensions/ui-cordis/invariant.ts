/**
 * Package-owned invariant companion for `@isomoes/dsh-web-ui/client/ui-cordis`.
 * @module @isomoes/dsh-web-ui/client/ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@isomoes/dsh-web-ui/client/ui-cordis'
