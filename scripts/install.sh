...
main() {
  ...
  # Install
  echo ""
  info "Installing ikanban..."
  echo "  Running: $INSTALL_CMD"
  echo ""

  if eval "$INSTALL_CMD"; then
    echo ""
    success "ikanban installed successfully!"
    echo ""
    echo "  Get started:"
    echo "    ikanban                 # Start server on port 3000"
    echo "    ikanban --help          # Show all options"
    echo ""
    echo "  Prerequisites:"
